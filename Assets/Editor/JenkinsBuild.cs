...
// https://gist.github.com/Jawnnypoo/366bbcc7f65e85154a15class 
class JenkinsBuild {
    static string[] SCENES = FindEnabledEditorScenes(); 
    static string GAME_NAME = "HorrorGame"; 
    static string TARGET_DIR = "~/Desktop/Untitled Horror Game"; 
    static void PerformAllBuilds() { PerformWindowsBuild(); }
    ...
    { 
        ...
        { 
            if (!scene.enabled) { continue; } EditorScenes.Add(scene.path); 
        } 
